...
contract DepositLogMock {
    ...
    */
    ...
    // `TBTCDepositTokenMock` mints a token for every new Deposit.
    ...
    function setTbtcDepositToken(TBTCDepositTokenMock _tbtcDepositTokenAddress)
        internal
    {
        require(
